...
* Can you animate or draw? Can you use pen/paper/whiteboard/tablet? ([an example demo for CS 64 by Rory Zahedi (W21 cohort)](https://drive.google.com/file/d/1hAHEpyMbGteUSycvUL7p_FXabTQPtZl0/view?usp=sharing))
* Can you use physical objects to illustrate/explain different concepts? ([an example](https://youtu.be/pIGlveXVlIo))
